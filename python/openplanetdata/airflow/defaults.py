...
GDAL_FULL_IMAGE = "ghcr.io/osgeo/gdal:ubuntu-full-3.13.0"
GDAL_SMALL_IMAGE = "ghcr.io/osgeo/gdal:ubuntu-small-3.12.3"
...
SHARED_PLANET_OSM_PARQUET_PATH = f"{OPENPLANETDATA_SHARED_DIR}/planet-latest.osm.parquet"
